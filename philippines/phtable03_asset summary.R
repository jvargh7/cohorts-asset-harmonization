...
var_order <- read_csv(paste0(path_harmonization_folder,"/philippines/working/cs all items indices loadings.csv")) %>% 
...
write.csv(tab03,paste0(path_harmonization_folder,"/philippines/working/table03.csv"))

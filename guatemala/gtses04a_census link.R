...
# SAVE ---------------
saveRDS(ses_masters,paste0(path_harmonization_folder,"/guatemala/working/ses_masters for COHORTS.RDS"))
write_dta(ses_masters,paste0(path_harmonization_folder,"/guatemala/working/ses_masters for COHORTS.dta"),version=12)

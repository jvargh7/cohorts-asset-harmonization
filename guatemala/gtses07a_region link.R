...
# SAVE ---------------
saveRDS(ses_region,paste0(path_harmonization_folder,"/guatemala/working/ses_region with harmonized for COHORTS.RDS"))
write_dta(ses_region,paste0(path_harmonization_folder,"/guatemala/working/ses_region with harmonized for COHORTS.dta"),version=12)

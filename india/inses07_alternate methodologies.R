...
output_wealth_efa$scores <- psych::factor.scores(x,output_wealth_efa,method = "components")   #find the scores from the response data set with the p3 pca solution

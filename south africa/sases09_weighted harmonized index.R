...
x = pca_df %>% 
  dplyr::select(-year,-bttid,-non_na_assets,-w) %>% as.matrix()

polychoric_out <- polychoric_pca(x,pca_vars,w=pca_df$w)   
saveRDS(polychoric_out,paste0(path_harmonization_folder,"/south africa/working/polychoric_out weighted.RDS"))
